...
class Filter_Dropdown(BaseClass):
    ...
    def clickPriceLowToHigh(self):
        ...
        self.select_option_in_dropdown(self._filter1,'tag',optionValue='lohi')
    ...
    def clickPriceHighToLow(self):
        ...
        self.select_option_in_dropdown(self._filter1,'tag',optionText='Price (high to low)')
    ...
    def clickFilterA_Z(self):
        ...
        self.select_option_in_dropdown(self._filter1,'tag',optionIndex=0)
