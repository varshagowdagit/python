...
ele = wait.until(lambda x:x.find_element(AppiumBy.ANDROID_UIAUTOMATOR,'new UiScrollable(new UiSelector()).scrollIntoView(text("ZOOM"))'))
action = TouchAction(driver)
#action.tap(ele,52,11,1)
